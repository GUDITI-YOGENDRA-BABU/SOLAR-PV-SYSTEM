...
genData = readtable('C:\Users\gudit\PVsyst7.0_Data\UserHourly\GRID CONNECTED WITH SHADING_Project_VC0_HourlyRes_1.CSV');
disp(genData)
...
xlabel('Sample Index');
ylabel('AC Power (W)');
title('Grid-Connected with shading PV: Actual vs Predicted AC Power');
grid on;
